...
## RUN 08/07/2024 R version 4.4.1 (2024-06-14 ucrt) -- "Race for Your Life"
...
Selecting a max missingness of 1 for nuclear, 1 for mito and 0.9 for Wb to be more stringent.
...
--recode --out nuclear_samples3x_missing1.chr1to4
#After filtering, kept 128 out of 128 Individuals
Outputting VCF file...
After filtering, kept 149467 out of a possible 194553 Sites


vcftools --vcf nuclear_samples3x_missing1.chr1to4.recode.vcf --remove-indels
#After filtering, kept 128 out of 128 Individuals
After filtering, kept 149467 out of a possible 149467 Sites

vcftools --vcf nuclear_samples3x_missing1.chr1to4.recode.vcf --keep-only-indels
#After filtering, kept 128 out of 128 Individuals
After filtering, kept 0 out of a possible 149467 Sites - this makes sense because I removed the indels earlier and only focused on the SNPs.
...
#After filtering, kept 128 out of 128 Individuals
#After filtering, kept 38108 out of a possible 194553 Sites
...
#After filtering, kept 128 out of 128 Individuals
#After filtering, kept 33649 out of a possible 194553 Sites
...
#After filtering, kept 128 out of 128 Individuals
#After filtering, kept 38388 out of a possible 194553 Sites
...
#After filtering, kept 128 out of 128 Individuals
#After filtering, kept 39322 out of a possible 194553 Sites

# chrX
vcftools --vcf nuclear_samples3x_missing1.recode.vcf \
--chr dirofilaria_immitis_chrX \
--recode --out nuclear_samples3x_missing1.chrX
#After filtering, kept 128 out of 128 Individuals
#After filtering, kept 44829 out of a possible 194553 Sites

# Australian samples only
grep '^AUS' ../nuclear_samplelist.keep > ../AUS_samplelist.keep

vcftools --vcf nuclear_samples3x_missing1.chr1to4.recode.vcf \
--keep ../AUS_samplelist.keep \
--recode --out nuclear_samples3x_missing1.chr1to4.AUS
