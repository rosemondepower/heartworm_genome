...
cd /lustre/scratch125/pam/teams/team333/rp24/DIRO/DATA/BATCH3/02_VARIANTS/TREEMIX

vcftools \
--gzvcf Dirofilaria_immitis_Dec2023.nuclear_SNPs.final.recode.RENAMED.vcf \
...
#Outputting VCF file...
#After filtering, kept 7829 out of a possible 256535 Sites
...
#After filtering, kept 7829 out of a possible 7829 Sites

# after pruning
vcftools --gzvcf treemix.LDpruned.vcf.gz
# After filtering, kept 81 out of 81 Individuals
#After filtering, kept 3454 out of a possible 3454 Sites
